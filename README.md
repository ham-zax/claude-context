...
[![npm - core](https://img.shields.io/npm/v/@zokizuan/claude-context-core?label=%40zokizuan%2Fclaude-context-core&logo=npm)](https://www.npmjs.com/package/@zokizuan/claude-context-core)
[![npm - mcp](https://img.shields.io/npm/v/@zokizuan/claude-context-mcp?label=%40zokizuan%2Fclaude-context-mcp&logo=npm)](https://www.npmjs.com/package/@zokizuan/claude-context-mcp)
...
- **`@zokizuan/claude-context-core`**: Core indexing engine with embedding and vector database integration
- **VSCode Extension**: Semantic Code Search extension for Visual Studio Code
- **`@zokizuan/claude-context-mcp`**: Model Context Protocol server for AI agent integration
...
The `@zokizuan/claude-context-core` package provides the fundamental functionality for code indexing and semantic search.

```typescript
import { Context, MilvusVectorDatabase, OpenAIEmbedding } from '@zokizuan/claude-context-core';
...
```bash
# Clone repository
git clone https://github.com/ham-zax/claude-context.git
cd claude-context
...
- [GitHub Repository](https://github.com/ham-zax/claude-context)
