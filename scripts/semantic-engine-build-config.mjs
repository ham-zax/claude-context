...
export const COMPILE_UNITS = [
    ...
    'languages/java/java_stdlib_data.c',
    'languages/csharp/cs_lsp.c',
    'languages/csharp/cs_stdlib_data.c',
    'languages/cpp/c_lsp.c',
    'languages/cpp/c_stdlib_data.c',
    'languages/cpp/cpp_stdlib_data.c',
    'languages/rust/rust_lsp.c',
    ...
    'grammars/tree-sitter-c-sharp/parser.c',
    'grammars/tree-sitter-c-sharp/scanner.c',
    'grammars/tree-sitter-cpp/parser.c',
