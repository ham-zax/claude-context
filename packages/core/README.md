...
[![npm version](https://img.shields.io/npm/v/@zokizuan/claude-context-core.svg)](https://www.npmjs.com/package/@zokizuan/claude-context-core)
[![npm downloads](https://img.shields.io/npm/dm/@zokizuan/claude-context-core.svg)](https://www.npmjs.com/package/@zokizuan/claude-context-core)
...
} from '@zokizuan/claude-context-core';
...
```typescript
import { Context, MilvusVectorDatabase, VoyageAIEmbedding } from '@zokizuan/claude-context-core';
