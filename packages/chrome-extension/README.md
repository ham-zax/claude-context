...
- **[@zokizuan/claude-context-core](../core)** - Core indexing engine used by this extension
- **[@zokizuan/claude-context-vscode-extension](../vscode-extension)** - VSCode integration
- **[@zokizuan/claude-context-mcp](../mcp)** - MCP server integration
